...
MariaDB [(none)]> use academia_cursos
Database changed
MariaDB [academia_cursos]> select* from cursos
    -> ;
+----------+--------------+-------------------------------+---------------------------------------------+-------+--------+--------------+------------+--------+-----------------+-------------+
...
MariaDB [academia_cursos]> UPDATE cursos
    -> SET descripcion = 'Introducción a la seguridad informática y redes',
...
|        5 | DIS001       | Adobe Photoshop Avanzado      | Retoque fotogr├ífico y composici├│n digital       |    30 | 200.00 | 2024-11-15   | 2025-01-15 |     15 |               4 |           5 |
|        6 | MKT001       | SEO y SEM                     | Posicionamiento en buscadores y publicidad      |    35 | 250.00 | 2025-01-10   | 2025-03-10 |     20 |               5 |           6 |
|        7 | CIBER001     | Fundamentos de Ciberseguridad | Introducci?n a la seguridad inform?tica y redes |    45 | 310.00 | 2025-02-03   | 2025-04-25 |     18 |               6 |           7 |
+----------+--------------+-------------------------------+-------------------------------------------------+-------+--------+--------------+------------+--------+-----------------+-------------+
...
MariaDB [academia_cursos]> UPDATE matriculas
    -> SET importe_pagado = 310.00,
    ->     estado = 'Activa'
    -> WHERE id_curso = 7
    ->   AND estado = 'Pendiente'
    ->   AND importe_pagado IS NULL;
...
|            8 |         7 |        6 | 2024-10-12      |         225.00 |     10.00 | Activa |
|            9 |         8 |        1 | 2024-10-16      |         350.00 |      0.00 | Activa |
|           17 |         9 |        7 | 2025-01-15      |         310.00 |      0.00 | Activa |
|           18 |        10 |        7 | 2025-01-15      |         310.00 |      0.00 | Activa |
|           19 |        11 |        7 | 2025-01-15      |         310.00 |      0.00 | Activa |
+--------------+-----------+----------+-----------------+----------------+-----------+--------+
12 rows in set (0.001 sec)
...
MariaDB [academia_cursos]> UPDATE profesores
    -> SET salario = salario * 1.08
    -> WHERE (id_departamento = 1 OR id_departamento = 6)
    ->   AND salario < 2200;
Query OK, 3 rows affected (0.003 sec)
Rows matched: 3  Changed: 3  Warnings: 0
...
| id_profesor | nif       | nombre | apellidos          | email                  | telefono  | fecha_alta | salario | id_departamento |
+-------------+-----------+--------+--------------------+------------------------+-----------+------------+---------+-----------------+
|           1 | 12345678A | Carlos | Mart├¡nez L├│pez     | cmartinez@academia.com | 600111222 | 2019-09-01 | 2268.00 |               1 |
|           2 | 23456789B | Laura  | S├ínchez Ruiz       | lsanchez@academia.com  | 600222333 | 2019-09-01 | 2106.00 |               1 |
|           3 | 34567890C | Miguel | Garc├¡a Fern├índez   | mgarcia@academia.com   | 600333444 | 2020-01-10 | 1800.00 |               2 |
|           4 | 45678901D | Ana    | Torres Blanco      | atorres@academia.com   | 600444555 | 2020-03-15 | 2200.00 |               3 |
|           5 | 56789012E | Pedro  | Jim├®nez Vega       | pjimenez@academia.com  | 600555666 | 2021-09-01 | 1750.00 |               4 |
|           6 | 67890123F | Sof├¡a  | Romero Castro      | sromero@academia.com   | 600666777 | 2022-01-20 | 1900.00 |               5 |
|           7 | 78901234G | Isabel | Fuentes Mora       | ifuentes@academia.com  | 600777888 | 2025-01-10 | 2214.00 |               6 |
+-------------+-----------+--------+--------------------+------------------------+-----------+------------+---------+-----------------+
7 rows in set (0.001 sec)
...
MariaDB [academia_cursos]> UPDATE alumnos
    -> SET activo = 0
    -> WHERE telefono IS NULL
    ->   AND (fecha_matricula < '2024-10-01'
    ->        OR fecha_matricula > '2025-02-01');
